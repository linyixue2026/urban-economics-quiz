...
| 测验 | 初试码 | 补试码 |
|------|--------|--------|
| Test 01 - 城市的产生 | `UE2026T01` | `RESET01` |
| Test 02 - 土地市场与地租 | `UE2026T02` | `RESET02` |
...
## 📝 如何添加新测验（Test 03、Test 04...）

### 命名规范（重要！）

| 项目 | 格式 | 示例 |
|------|------|------|
| 测验 ID | `testNN`（两位数） | `test01`, `test02`, `test03` |
| 测验标题 | `Test NN - 主题` | `Test 01 - 城市的产生` |
| 初试码 | `UE2026T` + NN | `UE2026T01`, `UE2026T02` |
| 补试码 | `RESET` + NN | `RESET01`, `RESET02` |
| 二维码文件 | `quiz-testNN-qrcode.png` | `quiz-test01-qrcode.png` |

### 当前测验列表

| 测验 ID | 标题 | 题库数 | 抽题数 | 初试码 | 补试码 | 链接 |
|---------|------|--------|--------|--------|--------|------|
| test01 | Test 01 - 城市的产生 | 17 | 10 | `UE2026T01` | `RESET01` | [进入](https://dashing-manatee-7619b2.netlify.app/?id=test01) |
| test02 | Test 02 - 土地市场与地租 | 15 | 10 | `UE2026T02` | `RESET02` | [进入](https://dashing-manatee-7619b2.netlify.app/?id=test02) |
...
const QUIZZES = {
    ...
    'test03': {
        title: 'Test 03 - 新主题',
        entryCode: 'UE2026T03',      // 初试码（格式：UE2026T + 两位数）
        resetCode: 'RESET03',         // 补试码（格式：RESET + 两位数）
...
| Test 01 - 城市的产生 | `UE2026T01` | `RESET01` |
| Test 02 - 土地市场与地租 | `UE2026T02` | `RESET02` |
| Test 03 | `UE2026T03` | `RESET03` |

> ⚠️ **每次添加新测验后，必须更新本文件的「考试码一览」和「测验列表」表格！**
